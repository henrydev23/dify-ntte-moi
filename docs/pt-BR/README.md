...
Após a execução, você pode acessar o painel do Dify no navegador em [https://dify-ntte-moi-web.vercel.app/install](https://dify-ntte-moi-web.vercel.app/install) e iniciar o processo de inicialização.
