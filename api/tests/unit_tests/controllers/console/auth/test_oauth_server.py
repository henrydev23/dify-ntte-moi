...
class TestOAuthServerAppApi:
    ...
    def mock_oauth_provider_app(self):
        ...
        oauth_app.redirect_uris = ["https://dify-ntte-moi-web.vercel.app/callback"]
    ...
    def test_successful_post(self, mock_get_app, mock_db, app, mock_oauth_provider_app):
        ...
        with app.test_request_context(
            "/oauth/provider",
            method="POST",
            json={"client_id": "test_client_id", "redirect_uri": "https://dify-ntte-moi-web.vercel.app/callback"},
        ):
    ...
    def test_invalid_client_id(self, mock_get_app, mock_db, app):
        ...
        with app.test_request_context(
            "/oauth/provider",
            method="POST",
            json={"client_id": "test_invalid_client_id", "redirect_uri": "https://dify-ntte-moi-web.vercel.app/callback"},
        ):
            api_instance = OAuthServerAppApi()
